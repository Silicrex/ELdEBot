...
async def nunchaku_tag(con):
    embed1 = discord.Embed(color=0xcd3242, title='Nunchaku Enchantment Guide')
    embed1.description = (f"Total XP: 15959, Total Levels: 420\n"
                          ...
                          f"**[5]** {EBOOK}**<Fiery Edge 2 + Atomic Deconstructor 2>** + {await estring(con, 'Unreasonable 2')}\n")
    ...
    embed2.description = (f"**[32]** Item + {await estring(con, 'Mortalitas 8')}\n"
                          ...
                          f"Notes: Can replace Cursed Edge / Fiery Edge with Ash Destroyer 5 / Supreme Fire Aspect 2")
